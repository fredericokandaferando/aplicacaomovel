...
''';
    ...
    if (response.statusCode == 200) {
      ...
      print(responseBody);
      parseSoapResponse(responseBody); 
     // bool credentialsValid = extractCredentialsValidity(responseBody);
      // Implemente a função para processar a resposta XML
...
bool extractCredentialsValidity(String soapResponse) {
  final document = xml.XmlDocument.parse(soapResponse);

  // Extrair o elemento que indica se as credenciais são válidas
  final isValidNode = document.findElements('IsValid').first;

  // Verificar o valor dentro do elemento
  if (isValidNode != null && isValidNode.innerText== 'true') {
