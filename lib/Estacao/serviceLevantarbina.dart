...
Future<void> levantarBicicleta(String userEmail, int stationId,BuildContext context) async {
  final String url = MySharedPreferences.ip + "/estacao/$userEmail/bike/$stationId";
