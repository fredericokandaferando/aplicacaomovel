      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            wifiP2PInfo != null
                ? Text(
                    "conectado: ${wifiP2PInfo?.isConnected}, isGroupOwner: ${wifiP2PInfo?.isGroupOwner}, groupFormed: ${wifiP2PInfo?.groupFormed}, groupOwnerAddress: ${wifiP2PInfo?.groupOwnerAddress}, clients: ${wifiP2PInfo?.clients}")
            ...
            ElevatedButton(
              ...
              child: const Text("verifique o wi-fi ativado"),
            ),
            ElevatedButton(
              onPressed: () async {
                print(
              ...
              child: const Text("pedir permissão de localização"),
            ),
            ElevatedButton(
              onPressed: () async {
                print(await _flutterP2pConnectionPlugin.askStoragePermission());
              },
              child: const Text("pedir permissão de armazenamento"),
            ),
            ElevatedButton(
              onPressed: () async {
                print(
            ...
            ElevatedButton(
              ...
              child: const Text("ativar wifi"),
            ),
            ElevatedButton(
              onPressed: () async {
                bool? created = await _flutterP2pConnectionPlugin.createGroup();
                snack("grupo criado: $created");
              },
              child: const Text("grupo criado"),
            ),
            ElevatedButton(
              onPressed: () async {
                bool? removed = await _flutterP2pConnectionPlugin.removeGroup();
                snack("grupo removido: $removed");
              },
              child: const Text("grupo removido/desconectar"),
            ),
            ElevatedButton(
              onPressed: () async {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                snack("parou de descobrir $stopped");
              },
              child: const Text("parar a descoberta"),
            ),
            ElevatedButton(
              onPressed: () async {
                startSocket();
            ...
            ElevatedButton(
              ...
              child: const Text("enviar arquivo do telefone"),
              style: ElevatedButton.styleFrom(  
                          backgroundColor: const Color.fromARGB(255, 135, 3, 135),         
                        ), 
            ),
